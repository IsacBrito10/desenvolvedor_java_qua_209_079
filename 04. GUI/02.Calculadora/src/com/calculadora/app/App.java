...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // do while
        do {
            opcao = JOptionPane.showInputDialog(null, "Selecione a opção:", "Calculadora", JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);  
            ...
            if (opcao == "Somar"){
                ...
                JOptionPane.showMessageDialog(null,
                "O resultado da subtração é: " + calculadora.subtrair(calculadora.getX(), calculadora.getY()),
                "Subtração",
                JOptionPane.INFORMATION_MESSAGE);
            }
            else if (opcao == "Multiplicar"){
                JOptionPane.showMessageDialog(null,
                "O resultado da multiplicação é: " + calculadora.multiplicar(calculadora.getX(), calculadora.getY()),
                "Multiplicação",
                JOptionPane.INFORMATION_MESSAGE);
            }
