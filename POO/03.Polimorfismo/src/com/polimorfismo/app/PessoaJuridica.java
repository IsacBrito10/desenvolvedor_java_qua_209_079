...
// construtor
 ...
 // metodo
    public String cumprimentar(){
        return "Olá, somos da empresa " + this.nomeFantasia + " da razão social " + this.razaoSocial + " cujo CNPJ é " + this.cnpj + ". Nosso e-mail é " + this.email + ", nosso telefone de contato é " + this.telefone + " e nosso endereço é " + this.endereco + ".";
    }
}
